	...
	export default {
		data() {
			return {
				...
				textId: '',
				fileListName: [],
				// fileList2: [{name: 'kai.jpg', url: 'http://127.0.0.1:8795/image/download?name=kai.jpg'}, {name: 'food2.jpeg', url: 'https://fuss10.elemecdn.com/3/63/4e7f3a15429bfda99bce42a18cdd1jpeg.jpeg?imageMogr2/thumbnail/360x360/format/webp/quality/100'}]
				fileList2: []
			};
...
// 			this.findPersonList(para)
	  ...
	  searchPic(){
		  ...
		  for(var i=0;i<res.length;i++){
			  ...
			  res[i].url = 'http://127.0.0.1:8795/image/download?name='+res[i].picName;
			  // console.log(res[i])
		  }
		  _this.fileList2=res
