			...
			<el-main>
				...
				<el-dialog
				  ...
				  <el-form label-width="80px" class="demo-ruleForm" status-icon :rules="rules2" ref="passwordEditForm" :model="passwordEditForm">
				    ...
				    <el-input type="password"  auto-complete="off" v-model="passwordEditForm.pass"></el-input>
				    </el-form-item>
						<el-form-item label="确认密码" prop="checkPass">
						<el-input type="password"  auto-complete="off" v-model="passwordEditForm.checkPass"></el-input>
						</el-form-item>
				  </el-form>
				  <span slot="footer" class="dialog-footer">
